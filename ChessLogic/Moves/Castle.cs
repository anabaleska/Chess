...
namespace ChessLogic
{
	public class Castle : Move
	{
		...
		public override Position FromPos { get; }  //se odnesuva na kralot
		public override Position ToPos { get; }    //se odnesuva na kralot
		...
		{
			new NormalMove(FromPos, ToPos).Execute(board);  //za kralot
