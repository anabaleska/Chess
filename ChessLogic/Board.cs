...
namespace ChessLogic
{
    public class Board
    {
        ...
        public static Board Initital()
        {
            ...
            board.AddStartPiesces();
            return board;
        }

        private void AddStartPiesces()
        {
        ...
        public Counting CountPieces()
        {
            ...
            {
                Piece piece = this[pos];
                counting.Increment(piece.Color, piece.pieceType);
            }
            return counting;
        }
        ...
        {
            return PiecePositionsFor(color).First(pos => this[pos].pieceType == type);
        }
        ...
        private bool IsUnmovedKingAndRook(Position kingPos, Position rookPos)
        {
            ...
            return king.pieceType == PieceType.King && rook.pieceType == PieceType.Rook && !king.HasMoved && !rook.HasMoved;
        }
        ...
        private bool HasPawnInPosition(Player player, Position[] pawnPositions, Position skipPos)
        {
            ...
            {
                Piece piece = this[pos];
                if(piece == null || piece.Color != player || piece.pieceType != PieceType.Pawn)
                {
                    continue;
                }
